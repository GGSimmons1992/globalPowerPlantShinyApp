...
transposePowerplantsUSAFuelYear = transpose(powerplantsUSAFuelYear)
transposePowerplantsUSAFuelYear$V4 = c("Year",2013,2014,2015,2016,2017)
names(transposePowerplantsUSAFuelYear) = transposePowerplantsUSAFuelYear[1,]
```
...
preplotdf=transposePowerplantsUSAFuelYear[-1,]
data_long = melt(preplotdf, id="Year")
data_long$value

lineplot = ggplot(data_long, aes(x=Year,y= value, color= variable,group=1)) + ylab("Energy Produce MWH") + xlab("Year") + geom_line()
